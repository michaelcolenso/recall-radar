/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 260a994017d3447856b1a19428b51c62)
// Runtime types generated with workerd@1.20260507.1 2026-05-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PipelineAgent" | "RecallMcp";
	}
	interface Env {
		DB: D1Database;
		AI: Ai;
		SITE_URL: "https://recalledrides.com";
		ENVIRONMENT: "production";
		GOOGLE_SITE_VERIFICATION: "";
		CF_ANALYTICS_TOKEN: "";
		NHTSA_VIN_SESSION_TS: "";
		NHTSA_VIN_SESSION_KEY: "";
		AFFILIATE_PARTNERS: "";
		TURNSTILE_SITE_KEY: "";
		ALERT_FROM_ADDRESS: "";
		...
		RECALL_MCP: DurableObjectNamespace<import("./src/index").RecallMcp>;
		...
		ALERT_DIGEST_WORKFLOW: Workflow<Parameters<import("./src/index").AlertDigestWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "ENVIRONMENT" | "GOOGLE_SITE_VERIFICATION" | "CF_ANALYTICS_TOKEN" | "NHTSA_VIN_SESSION_TS" | "NHTSA_VIN_SESSION_KEY" | "AFFILIATE_PARTNERS" | "TURNSTILE_SITE_KEY" | "ALERT_FROM_ADDRESS" | "EMAIL_POSTAL_ADDRESS" | "ADSENSE_CLIENT" | "ADSENSE_SLOT">> {}
}
