  ...
  <article class="rr-readout ${severityClass}">
    <div class="rr-readout__header">
      ...
      <div class="rr-readout__header-right">
        ${recall.report_received_date ? `<div class="rr-readout__date"><time datetime="${escapeHtml(recall.report_received_date)}">${escapeHtml(recall.report_received_date)}</time></div>` : ""}
